          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-cyan-100 mt-1">
                {mode === 'login' ? 'Sign in to your account' : 'Join PropLink today'}
              </p>
            </div>
            <button 
              onClick={onClose}
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 ${
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-12 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 ${
              ...
              <ul className="text-sm text-gray-600 space-y-1">
                {userType === 'owner' ? (
                  <>
                    ...
                    <li>• Manage your listings anytime</li>
                    <li>• Connect with verified seekers</li>
                  </>
                ) : (
                  <>
                    <li>• Browse all properties for FREE</li>
                    <li>• Subscribe to view owner contacts</li>
