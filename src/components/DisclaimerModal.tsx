      ...
      >
        ...
        <div className="p-6 max-h-96 overflow-y-auto">
          <div className="prose prose-sm text-gray-600">
            ...
            <p className="mb-4">Welcome to PropLink. By using this platform, you acknowledge and agree to the following terms:</p>
            <div className="bg-gray-50 rounded-lg p-4 mb-4">
              <h4 className="font-semibold text-gray-800 mb-2 flex items-center gap-2">
                <Shield className="w-5 h-5 text-blue-600" />
                Platform Role
              </h4>
              <p className="text-sm">PropLink operates solely as a <strong>listing and contact facilitation platform</strong>. We connect property owners with potential tenants and buyers but do not participate in, verify, or guarantee any transactions, agreements, or communications between parties.</p>
            </div>
            <div className="bg-red-50 rounded-lg p-4 mb-4">
              <h4 className="font-semibold text-red-800 mb-2">Limitation of Liability</h4>
              <p className="text-sm text-red-700">PropLink, its owners, employees, and affiliates are <strong>NOT responsible</strong> for:</p>
            ...
            <div className="bg-amber-50 rounded-lg p-4 mb-4">
              ...
              <p className="text-sm text-amber-700">All transactions are conducted <strong>at your own risk</strong>. We strongly recommend:</p>
            ...
            <p className="text-sm text-gray-500 mt-4">By clicking "I Agree & Continue", you confirm that you have read, understood, and agree to these terms.</p>
          </div>
        </div>
        ...
        <div className="p-6 border-t bg-gray-50">
          <label className="flex items-start gap-3 cursor-pointer mb-4">
            ...
            <span className="text-sm text-gray-700">
              I have read and understood the disclaimer. I agree that PropLink is not responsible for any transactions, disputes, or losses, and I will use this platform at my own risk.
            </span>
          </label>
          <button
            onClick={onAccept}
